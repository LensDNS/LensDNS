...
func (c *dhcpConn) broadcast(respData []byte, peer *net.UDPAddr) (n int, err error) {
	...
	// https://github.com/LensDNS/LensDNS/issues/3289.  The DHCP
	...
	//
	// See https://github.com/LensDNS/LensDNS/issues/3480 and
	// https://github.com/LensDNS/LensDNS/issues/3366.
	//
	// See also https://github.com/LensDNS/LensDNS/issues/3539.
