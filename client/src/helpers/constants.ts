...
export const REPOSITORY = {
    URL: 'https://github.com/LensDNS/LensDNS',
    TRACKERS_DB: 'https://github.com/LensDNS/LensDNS/tree/master/client/src/helpers/trackers/trackers.json',
    ISSUES: 'https://github.com/LensDNS/LensDNS/issues/new/choose',
};

export const CLIENT_ID_LINK = 'https://github.com/LensDNS/LensDNS/wiki/Clients#clientid';
export const MANUAL_UPDATE_LINK = 'https://github.com/LensDNS/LensDNS/wiki/FAQ#manual-update';
export const PORT_53_FAQ_LINK = 'https://github.com/LensDNS/LensDNS/wiki/FAQ#bindinuse';
...
export const UPSTREAM_CONFIGURATION_WIKI_LINK =
    'https://github.com/LensDNS/LensDNS/wiki/Configuration#upstreams';
